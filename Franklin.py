...
def get_franklin(message_id):
	return current_Franklins.get(message_id)


class Franklin:

	def __init__(self, message_to_be_reacted_to, valid_reactions, functions, data):
		...
		current_Franklins[message_to_be_reacted_to.id] = self
