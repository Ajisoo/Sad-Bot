...
class Franklin:
	...
	def __init__(self, bot, message_to_be_reacted_to, valid_reactions, functions, data, lifespan=180.0, remove_valid_reactions=True):
		...
		t = threading.Timer(lifespan, remove_franklin, (bot, message_to_be_reacted_to.id))
		t.start()
